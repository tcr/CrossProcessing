...
xpde.parser.Buffer.prototype.Read = function() {
	...
	try {
		...
		if( js.Boot.__instanceof($e8,haxe.io.Eof) ) {
			var e = $e8;
			{
...
xpde.parser.Parser.prototype.ForUpdate = function(scope) {
	var statement = this.StatementExpression();
	scope.pushStatement(statement);
	var statements = this.MoreStatementExpressions();
	{
...
xpde.parser.Parser.prototype.Statement0 = function(scope) {
	...
	if(this.la.kind == 31) {
		...
		this.Expect(41);
		var updateScope = new xpde.parser.BlockScope();
		if(this.StartOf(13)) {
			this.ForUpdate(updateScope);
		}
		this.Expect(39);
		var body = this.Statement0(scope);
		forScope.pushStatement(xpde.parser.Statement.SLoop(conditional,body,false));
...
xpde.parser.Parser.prototype.checkModifierPermission = function(set,permission) {
	{ var $it13 = set.iterator();
	while( $it13.hasNext() ) { var modifier = $it13.next();
...
xpde.parser.Errors.prototype.SemErr = function(line,col,s) {
	...
	else haxe.Log.trace(s,{ fileName : "Parser.hx", lineNumber : 1932, className : "xpde.parser.Errors", methodName : "SemErr"});
	this.count++;
...
xpde.parser.Errors.prototype.Warning = function(line,col,s) {
	if(line == null) this.printMsg(line,col,s);
	else haxe.Log.trace(s,{ fileName : "Parser.hx", lineNumber : 1938, className : "xpde.parser.Errors", methodName : "Warning"});
}
...
xpde.parser.Errors.prototype.printMsg = function(line,column,msg) {
	...
	haxe.Log.trace(b,{ fileName : "Parser.hx", lineNumber : 1775, className : "xpde.parser.Errors", methodName : "printMsg"});
}
